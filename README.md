...
- The two home page photos in `images/` are licensed Adobe Stock images cropped to 1800 x 900; see `CONTENT.md` for the asset numbers. To swap a photo, save a new 2:1 JPEG over the same filename.
